...
export default function ContributionScheme() {
  ...
  const totalWeeklyContribution = extraContribution + preLoanCharge;
    ...
    onSuccess: (res: any) => {
      ...
      if (breakdown) {
        setRegularBreakdown({
          ...
          insurance: breakdown.insurance || "",
          eligibleLoanAfterInsurance:
            breakdown.eligibleLoanAfterInsurance || "",
              ...
              {isValidContribution && !!contribution && (
                <View>
                  <View style={styles.summaryBox}>
                    ...
                    <View style={styles.groupText}>
                      <Text style={styles.summaryText}>Insurance Fee</Text>
                      <Text style={styles.boldText}>
  ...
  ({
    ...
    <View>
      ...
      <Input
        ...
        placeholder="Enter Amount"
        value={formatAmount(preLoanCharge)}
        keyboardType="phone-pad"
        editable={false}
        showInfoIcon={true}
        infoTitle="Loan Management Fee over 4 years"
